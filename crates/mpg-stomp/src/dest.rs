...
//! name. `type_hint` rides in `mpg.type_hint` and/or is sniffed from the body.

use mpg_core::{ContentType, RouteKey};

pub const HDR_ORIGIN: &str = "mpg.origin_adapter";
pub const HDR_TYPE_HINT: &str = "mpg.type_hint";
pub const HDR_TOPIC: &str = "mpg.topic";
pub const HDR_ID: &str = "mpg.id";
